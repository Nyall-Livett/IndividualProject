...
class LLM4Handler(Handler):
    ...
    CSV_HEADERS: list = [
        "LLM4_mutation_score_1",
        "LLM4_code_coverage_1",
        "LLM4_mutation_score_2",
        "LLM4_code_coverage_2"
    ]
    ...
    def __init__(self, 
        ...
        self.LLM: ILanguageModel = ChatGptModelTuned("ft:gpt-3.5-turbo-1106:personal::9EJVtr5J")
        self.file_io = FileIO()
