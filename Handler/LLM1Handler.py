...
class LLM1Handler(Handler):
    ...
    CSV_HEADERS: list = [
        "LLM1_code_coverage_1",
        "LLM1_mutation_score_1",
        "LLM1_code_coverage_2",
        "LLM1_mutation_score_2"
    ]
    ...
    def __init__(self, 
        ...
        self.LLM: ILanguageModel = ChatGptModelTuned("ft:gpt-3.5-turbo-1106:personal::9EJVwa29:ckpt-step-740")
        self.file_io = FileIO()
